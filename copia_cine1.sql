...
CREATE TABLE `empleados_antiguos` (
  `Codigo_emp` varchar(10) CHARACTER SET latin1 NOT NULL,
  `Nombre_emp` varchar(100) CHARACTER SET latin1 NOT NULL,
  `Nacionalidad` varchar(70) CHARACTER SET latin1 NOT NULL
...
-- Dump completed on 2020-09-25 22:57:42
